class ContentsList {
  ...
  #stickySeriesTitle() {
    ...
    for (let el of series) {
      const stickable = document.querySelector('.stickable');
      const stickableOffset = stickable.offsetHeight;
      const titleWrapper = stickable.querySelector('.series-title');
      const treeTop = _this.resourceTree.offsetTop;
      const id = el.getAttribute('data-archival-object-id');
      const title = el.querySelector('.component-title').innerHTML;
